  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
    ...
    function srcAppLoginLoginModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      LoginPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        imports: [_shared_shared_module__WEBPACK_IMPORTED_MODULE_2__["SharedModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"].forChild(routes)],
    ...
    function srcAppLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _shared_tools__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./../shared/tools */
      ...
      var LoginPage = /*#__PURE__*/function () {
        function LoginPage(route, formBuilder, apiServices, tools, toastController) {
          ...
          value: function onLoginClick() {
            ...
            if (msg != '') {
              ...
              if (this.tools.isNetwork()) {
                this.tools.openLoader();
                this.apiServices.SendOTP(this.mobileno).subscribe(function (response) {
                  ...
                  if (res.status) {
                    ...
                    localStorage.setItem('mobileno', _this.mobileno);
