...
const routes: Routes = [
  ...
  {
    path: 'organizationdashboard',canActivate: [AuthGuard],
    loadChildren: () => import('./pages/organizationdashboard/organizationdashboard.module').then( m => m.OrganizationdashboardPageModule)
  },
];
